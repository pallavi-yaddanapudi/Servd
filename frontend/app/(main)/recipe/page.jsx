      ...
      <div className="min-h-screen bg-stone-50 pt-24 pb-16 ">
        <div className="container mx-auto max-w-4xl text-center py-20">
          ...
          <p className="text-stone-900 font-light">
            Our AI is creafting detailed instructions for{" "}
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-white p-6 border-2 border-stone-200 lg:sticky lg:top-24">
              ...
              {/* nutrition info */}
              {recipe.nutrition && (
                <div className="mt-6 border-t-2 border-stone-200">
            ...
            <div className="bg-white p-8 border-2 border-stone-200">
              ...
              <div className="mt-8 p-6 bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-green-200">
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="w-6 h-6 text-green-600 shrink mt-0.5" />
                  <div>
