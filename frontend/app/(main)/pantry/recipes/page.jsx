...
const PantryRecipesPage = () => {
  ...
  }, [recipesData, fetchSuggestions]);

  const recipes = recipesData?.recipes || [];
  const ingredientsUsed = recipesData?.ingredientsUsed || "";

  return (
    <div className="min-h-screen bg-stone-50 pt-24 pb-16 px-14">
      <div className="container mx-auto max-w-6xl">
        <div className="mb-8">
          ...
          <div className="flex items-center gap-3 mb-6">
            <ChefHat className="w-1 items-center gap-3 mb-6" />
            <div>
                ...
                {recipesData.recommendationsLimit === "unlimited" ? (
                  <>
                    ...
                    <span className="text-orange-700 font-light">
                      {" "}
                      Unlimites AI recommendations (Pro Plan)
                    </span>
                  </>
                ) : (
                  <span className="text-orange-700 font-light">
